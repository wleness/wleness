  ...
  return (
    <footer className="footer bg-[#A2FFF5] text-black flex py-12 px-16 clear-right">
      <div className="flex w-full flex-col sm:flex-row flex-wrap justify-between border-b pb-10 border-black">
        ...
        <div className="md:w-[25%] sm:w-[45%] md:pl-8 w-[90%]">
        ...
        <div className="md:w-[25%] sm:w-[50%] pt-4 md:pt-0 w-[90%]">
          <h6 className="font-bold">Services</h6>
          <p>Vaccination</p>
          <p>NDD</p>
          <p>Filled Prescription As Is</p>
          <p>Patient Referral</p>
          <p>Other roofing</p>
        </div>

        <div className="md:w-[25%] sm:w-[45%] pt-4 md:pt-0 w-[90%]">
