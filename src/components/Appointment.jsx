...
const Appointment = () => {
  return (
    <div className=" mt-5  md:ml-0 md:mb-20 rounded-xl text-[#343434] flex justify-center items-center bg-teal-200 bg-opacity-60 w-auto sm:w-full md:w-full h-[438px]">
